export enum EventType {
  REFETCH_BALANCES = "refetch_balances",
  REFETCH_BANK = "refetch_bank",
  REFETCH_PENDING_TRANSACTIONS = "refetch_pending_transactions",
  REFETCH_PENDING_USERS = "refetch_pending_users",
}
